...
const Home = () => {
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <section className="py-10 md:py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-5">
            <a href="/services" className="bg-white rounded-lg p-3 md:p-5 text-center shadow-md hover:shadow-xl transition">
            ...
            <a href="/gallery" className="bg-white rounded-lg p-3 md:p-5 text-center shadow-md hover:shadow-xl transition">
              <div className="bg-primary/10 w-10 h-10 md:w-14 md:h-14 rounded-full flex items-center justify-center mx-auto mb-2">
            ...
            <a href="/testimonials" className="bg-white rounded-lg p-3 md:p-5 text-center shadow-md hover:shadow-xl transition">
              <div className="bg-primary/10 w-10 h-10 md:w-14 md:h-14 rounded-full flex items-center justify-center mx-auto mb-2">
            ...
            <a href="/contact" className="bg-white rounded-lg p-3 md:p-5 text-center shadow-md hover:shadow-xl transition">
              <div className="bg-primary/10 w-10 h-10 md:w-14 md:h-14 rounded-full flex items-center justify-center mx-auto mb-2">
            ...
            <>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-5">
                {services.slice(0, visibleServices).map((service) => (
                  <div key={service.id} className="bg-white rounded-lg p-3 md:p-4 text-center shadow-md border border-gray-100">
      ...
      {/* PROJECTS - REAL DATA from Firebase */}
      <section className="py-10 md:py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-4 md:mb-6">
            <h2 className="text-xl md:text-2xl font-bold text-gray-900">Recent Projects</h2>
            <a href="/gallery" className="text-primary text-sm">View All →</a>
          </div>
      ...
      {/* TESTIMONIALS - REAL DATA from Firebase */}
      <section className="py-10 md:py-16">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-4 md:mb-6">
            <h2 className="text-xl md:text-2xl font-bold text-gray-900">What Clients Say</h2>
            <a href="/testimonials" className="text-primary text-sm">Read All →</a>
          </div>
            ...
            <>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5">
                {testimonials.slice(0, visibleTestimonials).map((testimonial) => (
                  <div key={testimonial.id} className="bg-white rounded-lg p-4 shadow-md border border-gray-100">
      ...
      <section className="py-8 md:py-12 bg-primary">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="/contact" className="bg-black text-white px-5 py-2 rounded-lg font-bold text-sm">Contact Us</a>
